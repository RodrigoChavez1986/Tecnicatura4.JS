...
app.use(express.static("../../client"));//redirigiendo a archivos estaticos
//cambiando
...
app.post("/create_preference", (req, res) => {//definir una ruta para crear una preferencia de pago
	...
	let preference = {
		...
		back_urls: {//cuando la compra se realiza con exito redirige al servidor
			"success": "http://localhost:3000",//pagina principal
			"failure": "http://localhost:3000",//si falla vuelvo a la pagina principal
...
app.listen(3000, () => {//Escucha el servidor en el puerto 8080
